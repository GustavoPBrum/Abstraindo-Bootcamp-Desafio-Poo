...
public class Bootcamp {
    ...
    // Final para não poder alterar a data
    private final LocalDate dataInicial = LocalDate.now();
    private final LocalDate dataFinal = dataInicial.plusDays(45);

    private Set<Dev> devsInscritos = new HashSet<>(); // A ordem de inserção é irrelevante
    private Set<Conteudo> conteudos = new LinkedHashSet<>(); // Aqui é o oposto
